      ...
      <div className="p-6 bg-white dark:bg-zinc-900 rounded-xl shadow-md space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
          <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
            ...
            <p className="text-2xl font-black">{scores.F}</p>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Η τάση ταύτισης με χαρακτήρες ταινιών, μυθιστορημάτων ή θεατρικών έργων.</p>
          </div>
          
          <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <h4 className="font-bold text-green-600 mb-1">Λήψη Οπτικής (PT)</h4>
            <p className="text-2xl font-black">{scores.PT}</p>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Η τάση να υιοθετεί κανείς αυθόρμητα την ψυχολογική οπτική γωνία των άλλων.</p>
          </div>

          <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <h4 className="font-bold text-purple-600 mb-1">Ενσυναισθητικό Ενδιαφέρον (EC)</h4>
            <p className="text-2xl font-black">{scores.EC}</p>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Κλίμακα που αξιολογεί συναισθήματα συμπόνιας προς τους άλλους.</p>
          </div>

          <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <h4 className="font-bold text-red-600 mb-1">Προσωπική Δυσφορία (PD)</h4>
            <p className="text-2xl font-black">{scores.PD}</p>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Συναισθήματα άγχους σε τεταμένες διαπροσωπικές καταστάσεις.</p>
          </div>
        </div>
